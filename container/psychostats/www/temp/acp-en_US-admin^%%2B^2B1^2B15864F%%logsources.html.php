<?php /* Smarty version 2.6.18, created on 2026-01-30 03:12:44
...
>
			<td class="idx"><?php echo '<a '; ?><?php if (! $this->_tpl_vars['log']['up']): ?><?php echo 'style="display: none"'; ?><?php endif; ?><?php echo ' class="up" href="'; ?><?php echo smarty_function_url(array('move' => 'up','id' => $this->_tpl_vars['log']['id']), $this);?><?php echo '"><img src="'; ?><?php echo $this->_reg_objects['theme'][0]->url(null);?><?php echo '/img/icons/arrow_up.png" alt="Move Up"></a><a '; ?><?php if (! $this->_tpl_vars['log']['down']): ?><?php echo 'style="display: none"'; ?><?php endif; ?><?php echo ' class="dn" href="'; ?><?php echo smarty_function_url(array('move' => 'down','id' => $this->_tpl_vars['log']['id']), $this);?><?php echo '"><img src="'; ?><?php echo $this->_reg_objects['theme'][0]->url(null);?><?php echo '/img/icons/arrow_down.png" alt="Move Down"></a>'; ?>
</td>
...
/img/icons/<?php if ($this->_tpl_vars['log']['enabled']): ?>tick<?php else: ?>cross<?php endif; ?>.png" alt="<?php if ($this->_tpl_vars['log']['enabled']): ?>Enabled<?php else: ?>Disabled<?php endif; ?>"></a></td>
		</tr>
<?php endforeach; else: ?>
...
/img/icons/tick.png" alt="Enable"> or cross <img src="<?php echo $this->_reg_objects['theme'][0]->url(null);?>
/img/icons/cross.png" alt="Disable"> to quickly enable or disable the log source.</p>
