<?php /* Smarty version 2.6.18, created on 2026-01-30 03:12:48
         compiled from acp/logsources_edit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'acp/logsources_edit.html', 16, false),array('modifier', 'escape', 'acp/logsources_edit.html', 29, false),)), $this); ?>
...
<div id="ls-username"<?php if ($this->_tpl_vars['errors']['username']): ?> class="err"<?php endif; ?>>
	...
	<input name="username" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['log']['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
<div id="ls-options"<?php if ($this->_tpl_vars['errors']['options']): ?> class="err"<?php endif; ?>>
	...
	<label>Options:</label>
	<textarea class="long" name="options" rows="5" wrap="soft"><?php echo ((is_array($_tmp=$this->_tpl_vars['form']['options'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea>
</div>
